 ...
 * vsr_rtcuda, real CUDA C compiled to PTX with clang's NVPTX backend (no NVIDIA SDK,
 ...
 * (AIVP bypass-mode call, rgba_to_nv12 below) is 8-bit only regardless of input, so p010_to_rgba
