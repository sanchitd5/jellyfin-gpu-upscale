 ...
 *   -> AIVP Process (bypass mode) -> RGBA8 surface -> rgba_to_nv12 -> NV12 CUDA frame.
...
#include "gu_vsr_nv12_rgba_ptx.h"   /* generated at build time from gu_vsr_nv12_rgba.cu (real
                                     ...
                                     * NVIDIA material, not extracted from any SDK). Own copy,
                                     * independent of gu_dlpp_nv12_rgba_ptx.h. semiplanar_to_rgba
 ...
 * accepted; anything else is rejected here with ENOSYS rather than misread. */
